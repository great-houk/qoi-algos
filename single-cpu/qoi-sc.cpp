...
std::vector<uint8_t> SingleCPUQOI::encode(const std::vector<uint8_t>& data, QOIEncoderSpec& spec) {
    int p = 0, run = 0;
...
std::vector<uint8_t> SingleCPUQOI::decode(const std::vector<uint8_t>& encoded_data, QOIDecoderSpec& spec) {
